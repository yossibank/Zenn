---
title: "iOSの証明書周りをイラストで読み解く 事前準備編"
emoji: "📝"
...
こちらは記事を通して読み解いていく証明書周りの概要図になります。

![概要図](/images/certificate/overview.png)

※ 概要を説明する上で、こちらの[記事](https://qiita.com/fujisan3/items/d037e3c40a0acc46f618)が大変分かりやすいため、こちらを参考に作成いたしました

今回はiOSの証明書周りを理解するための事前準備編として、データのやり取りの際に用いられるデータの暗号化、ならびに鍵について読み解いていきます。

![概要図詳細](/images/certificate/0_data_encrypt_1.png)

# 概要

まずはシンプルなAさんとBさんのデータのやり取りをイラストで表してみます。

![データのやり取り](/images/certificate/0_data_encrypt_2.png)

このままですと、悪意を持った第三者からデータを盗み見される可能性があります。

![データの盗み見](/images/certificate/0_data_encrypt_3.png)
...
![データの暗号化](/images/certificate/0_data_encrypt_4.png)
...
![共通鍵暗号方式](/images/certificate/0_data_encrypt_5.png)
...
![共通鍵暗号方式問題点](/images/certificate/0_data_encrypt_6.png)
...
![公開鍵暗号方式](/images/certificate/0_data_encrypt_7.png)
...
![公開鍵暗号方式問題点](/images/certificate/0_data_encrypt_8.png)
